...
const args = [
  ...
  "-c",
  `mcp_servers.ego_chat.env.EGO_CHAT_DATA_DIR=${JSON.stringify(dataDir)}`,
  "-c",
  `mcp_servers.ego_chat.env.EGO_CHAT_EGO_BROWSER=${JSON.stringify(config.egoBrowserCommand)}`,
  "-c",
  `mcp_servers.ego_chat.env.EGO_CHAT_SOCKET_PATH=${JSON.stringify(socketPath)}`,
  "-c",
